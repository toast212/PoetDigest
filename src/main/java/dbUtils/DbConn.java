...
public class DbConn {
    ...
    public DbConn() {
        ...
        String dbAndPass = "sp24_3308_tug44038?user=tug44038&password=Moh7Chi4";
        try {
            ...
            try {
                ...
                recordError("There was an issue connecting to the website. " + 
                "Please be patient while we work to fix the issue. DBConn: Problem getting driver:" 
                + e.getMessage());
            }
        } catch (Exception e) { // cant get the driver...
            recordError("There was an issue connecting to the website. " + 
